...
@section('content')
    ...
    <form class="form" action="{{route('admin.service.update')}}" method="POST" id="form_service_update"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <ul class="nav  nav-tabs" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="service_settings_tab" data-toggle="tab"
                                           href="#service_settings">
                                            <span class="nav-icon"><i class="flaticon2-settings"></i></span>
                                            <span class="nav-text">{{trans('services.service_settings_tab')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="service_details_ar_tab" data-toggle="tab"
                                           href="#service_details_ar"
                                           aria-controls="profile">
                                            <span class="nav-icon"><i class="flaticon2-layers-1"></i></span>
                                            <span class="nav-text">{{trans('services.service_details_ar_tab')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="service_details_en_tab" data-toggle="tab"
                                           href="#service_details_en"
                                           aria-controls="profile">
                                            <span class="nav-icon"><i class="flaticon2-layers-1"></i></span>
                                            <span class="nav-text">{{trans('services.service_details_en_tab')}}</span>
                                        </a>
                                    </li>
                                </ul>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#form_service_update').on('submit', function (e) {
            e.preventDefault();
            $.notifyClose();
            ...
            $.ajax({
                ...
                error: function (reject) {
                    ...
                    ProductPrintErrors(response.errors)
                },//end error
                complete: function () {
                    KTApp.unblockPage();
                },//end complete
        ...
        function ProductPrintErrors(msg) {
