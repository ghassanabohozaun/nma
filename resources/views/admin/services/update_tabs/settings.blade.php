                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div
                                    ...
                                    <div class="image-input-wrapper"
                                         style="background-image: url({{asset(Storage::url($service->photo))}})"></div>
                                    <label
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <select
                                    ...
                                    <option value="ar" {{$service->language == trans('general.ar') ? 'selected':''}}>
                                        {{trans('general.ar')}}
                                    </option>

                                    <option value="en" {{$service->language == trans('general.en') ? 'selected':''}}>
                                        {{trans('general.en')}}
                                    </option>
                                    <option
                                        value="ar_en" {{$service->language == trans('general.ar_en') ? 'selected':''}}>
                                        {{trans('general.ar_en')}}
                                    </option>
                                ...
                                <div class="form-check pl-0 radio-inline" style="padding-top: 10px">
                                    <label class="radio radio-outline">
                                        <input type="radio" id="is_treatment_area" name="is_treatment_area"
                                               {{$service->is_treatment_area =='1' ? 'checked': ''}}
                                               value="1"/>
                                        <span></span>
                                        {{trans('general.yes')}}
                                    </label>
                                    <label class="radio radio-outline">
                                        <input type="radio"  id="is_treatment_area"
                                               name="is_treatment_area"
                                               {{$service->is_treatment_area =='0' ? 'checked': ''}}
                                               value="0"/>
                                        <span></span>
                                        {{trans('general.no')}}
                                    </label>
