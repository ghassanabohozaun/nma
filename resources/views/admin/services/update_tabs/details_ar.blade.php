                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                   name="title_ar" id="title_ar" value="{{$service->title_ar}}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control form-control-solid form-control-lg"
                                   name="summary_ar" id="summary_ar"
                                   placeholder="{{trans('services.enter_summary_ar')}}" rows="3"
                                      autocomplete="off">{{$service->summary_ar}}</textarea>
                            <span class="form-text text-danger"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control details_ar"
                                      ...
                                      name="details_ar"
                                      id="details_ar">{{$service->details_ar}}</textarea>
                            <span class="form-text text-danger"
