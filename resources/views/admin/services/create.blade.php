...
@section('content')
    ...
    <form class="form" action="{{route('admin.services.store')}}" method="POST" id="form_service_store"
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#form_service_store').on('submit', function (e) {
            e.preventDefault();
            $.notifyClose();
            ////////////////////////////////////////////////////////////////////
            $('#language_error').text('');
            ...
            $.ajax({
                ...
                error: function (reject) {
                    ...
                    ServicePrintErrors(response.errors)
                },//end error
                complete: function () {
                    KTApp.unblockPage();
                },//end complete
        ...
        function ServicePrintErrors(msg) {
