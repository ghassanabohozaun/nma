...
@section('content')
    ...
    <form class="form" action="{!! route('admin.trainings.update') !!}" method="POST" id="form_training_update">
    @csrf
    <!--begin::Subheader-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">
                                {{trans('trainings.update_training')}}
                            </a>
                        </li>
                    </ul>
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <!--  style="background-image: url({{--asset(Storage::url(setting()->site_icon))--}})"-->
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($training->photo))}})">
                                                                </div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="ar"
                                                                    {{$training->language == trans('general.ar') ?'selected':''}}>
                                                                    {{trans('general.ar')}}
                                                                </option>

                                                                <option value="en"
                                                                    {{$training->language == trans('general.en') ?'selected':''}}>
                                                                    {{trans('general.en')}}
                                                                </option>
                                                                <option value="ar_en"
                                                                    {{$training->language == trans('general.ar_en') ?'selected':''}}>
                                                                    {{trans('general.ar_en')}}
                                                                </option>
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       readonly value="{{$training->started_date}}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                ...
                                                                placeholder=" {{trans('trainings.enter_title_ar')}}"
                                                                autocomplete="off"/>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                ...
                                                                placeholder=" {{trans('trainings.enter_title_en')}}"
                                                                autocomplete="off"/>
...
@push('js')
    <script type="text/javascript">
        ...
        $('#form_training_update').on('submit', function (e) {
            e.preventDefault();
            $.notifyClose();
            /////////////////////////////////////////////////////////////////////////
            $('#photo_error').text('');
