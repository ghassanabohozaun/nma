...
@section('content')
    ...
    <form class="form" action="{{route('admin.offer.update')}}" method="POST" id="form_offer_update">
    @csrf
    <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($offer->photo))}});"></div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select
                                                                ...
                                                                <option
                                                                    value="ar" {{$offer->language == trans('general.ar') ?'selected':'' }}>
                                                                    {{trans('general.ar')}}
                                                                </option>

                                                                <option
                                                                    value="en" {{$offer->language == trans('general.en') ?'selected':'' }}>
                                                                    {{trans('general.en')}}
                                                                </option>
                                                                <option
                                                                    value="ar_en" {{$offer->language == trans('general.ar_en') ?'selected':'' }}>
                                                                    {{trans('general.ar_en')}}
                                                                </option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      autocomplete="off">{{$offer->details_ar}}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      autocomplete="off">{{$offer->details_en}}</textarea>
...
@push('js')
    <script type="text/javascript">
        ...
        $('#form_offer_update').on('submit', function (e) {
            e.preventDefault();
            $.notifyClose();
            //////////////////////////////////////////////////////////////
