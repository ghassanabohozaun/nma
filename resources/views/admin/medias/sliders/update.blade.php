                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select
                                                                ...
                                                                <option
                                                                    value="ar" {{$slider->language == trans('general.ar') ? 'selected':''}} >
                                                                    {{trans('general.ar')}}
                                                                </option>

                                                                <option
                                                                    value="en" {{$slider->language == trans('general.en') ? 'selected':''}}>
                                                                    {{trans('general.en')}}
                                                                </option>
                                                                <option
                                                                    value="ar_en" {{$slider->language == trans('general.ar_en') ? 'selected':''}}>
                                                                    {{trans('general.ar_en')}}
                                                                </option>
                                                            </select>
                                                            <span class="form-text text-danger"
                                                                ...
                                                                <select
                                                                    ...
                                                                    @if( LaravelLocalization::getCurrentLocale() =='ar')
                                                                        @foreach(App\Models\Service::where('title_ar' ,'<>',null)->get() as $service)
                                                                            <option
                                                                                {{$slider->service_id == old('service_id',$service->id) ? 'selected':''}}
