...
@section('content')
    ...
    <form class="form" action="{{route('admin.sections.update')}}" method="POST" id="form_sections_update">
    @csrf
    <!--begin::Subheader-->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select
                                                                ...
                                                                <option
                                                                    value="ar" {{$section->language == trans('general.ar') ?'selected':'' }}>
                                                                    {{trans('general.ar')}}
                                                                </option>

                                                                <option
                                                                    value="en" {{$section->language == trans('general.en') ?'selected':'' }}>
                                                                    {{trans('general.en')}}
                                                                </option>
                                                                <option
                                                                    value="ar_en" {{$section->language == trans('general.ar_en') ?'selected':'' }}>
                                                                    {{trans('general.ar_en')}}
                                                                </option>
...
@push('js')
    <script type="text/javascript">
        ...
        $('#form_sections_update').on('submit', function (e) {
            e.preventDefault();
            $.notifyClose();
            //////////////////////////////////////////////////////////////
