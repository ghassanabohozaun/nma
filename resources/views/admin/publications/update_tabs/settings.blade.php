                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <select
                                    ...
                                    <option value="ar" {{$publication->language == trans('general.ar') ? 'selected':''}}>
                                        {{trans('general.ar')}}
                                    </option>

                                    <option value="en" {{$publication->language == trans('general.en') ? 'selected':''}}>
                                        {{trans('general.en')}}
                                    </option>
                                    <option value="ar_en" {{$publication->language == trans('general.ar_en') ? 'selected':''}}>
                                        {{trans('general.ar_en')}}
                                    </option>
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div class="input-group date">
                                    <input type="text" class="form-control"
                                           id="add_date" name="add_date" value="{{$publication->add_date}}"
                                ...
                                <select class="form-control form-control-solid form-control-lg"
                                    ...
                                    @if( LaravelLocalization::getCurrentLocale() =='ar')
                                        @foreach(App\Models\Section::where('title_ar','<>',null)->get() as $section)
                                            <option
                                                value="{{$section->id}}"
                                                {{$publication->section_id == old('section_id',$section->id) ? 'selected': ''}}>
                                                {{$section->title_ar}}
                                            </option>
                                        @endforeach
                                    @else
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div
                                    ...
                                    <div class="image-input-wrapper"
                                         style="background-image: url({{asset(Storage::url($publication->photo))}})"></div>
                                    <label
