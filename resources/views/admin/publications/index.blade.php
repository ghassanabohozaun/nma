            ...
            <div class="d-flex align-items-center">
                ...
                <a href="{{route('admin.publications.create')}}"
                   class="btn btn-primary btn-sm font-weight-bold font-size-base  mr-1">
                    ...
                    {{trans('menu.add_new_publications')}}
                </a>
                &nbsp;
                                    ...
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            ...
                                            <table class="table d-table" id="m_table_1">
                                                ...
                                                <tr>
                                                    <th>#</th>
                                                    <th>@lang('publications.photo')</th>
                                                    <th>@lang('publications.title_ar')</th>
                                                    <th>@lang('publications.title_en')</th>
                                                    <th>@lang('publications.language')</th>
                                                    <th>@lang('publications.add_date')</th>
                                                    <th>@lang('publications.section_id')</th>
                                                    <th>@lang('publications.status')</th>
...
@push('js')
    ...
    <script>
        window.data_url = "{{route('admin.get.publications')}}";
        window.columns = [{data: "id"}, {data: "photo"},
            {data: "title_ar"}, {data: "title_en"}, {data: "language"},
            {data: "add_date"}, {data: "section_id"},{data: "status"},
             {data: "actions"},];
    </script>
    ...
    <script type="text/javascript">
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /// Show publication Delete alert  Function
        $(document).on('click', '.delete_publication_btn', function (e) {
            e.preventDefault();

            var id = $(this).data('id');
            $('#publication_delete_id').val(id);
            $.notifyClose();

            notify_message = " <i class='fa fa-trash' style='color:white'></i> &nbsp; {{trans('general.ask_delete_record')}}<br /><br />" +
                "<button type='button' id='btn_publication_delete'  class=' btn btn-outline-light btn-sm m-btn m-btn--air m-btn--wide '" +
                ">{{trans('general.yes')}}</button> &nbsp;" +
                "<button type='button' id='btn_publication_close' class=' btn btn-outline-light btn-sm m-btn m-btn--air m-btn--wide '" +
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /// Close publication Delete alert Function
        $('body').on('click', '#btn_publication_close', function (e) {
            e.preventDefault();
            $.notifyClose();
            $('#publication_delete_id').val('');
        });

        /////////////////////////////////////////////////////////////////////////////////
        ///  publication Delete  Function
        $('body').on('click', '#btn_publication_delete', function (e) {
            e.preventDefault();
            $.notifyClose();

            var id = $('#publication_delete_id').val();
